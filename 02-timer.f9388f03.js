...
class CountdownTimer {
    constructor(startBtnSelector, dateChosenSelector, daysSelector, hoursSelector, minutesSelector, secondsSelector){
        ...
        const options = {
            ...
            onClose: (selectedDate)=>{
                if (selectedDate[0] <= new Date()) {
                    this.startBtn.disabled = true;
                    (0, _notiflixDefault.default).Notify.failure("<\u0411\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430, \u043E\u0431\u0435\u0440\u0438 \u0434\u0430\u0442\u0443 \u0432 \u043C\u0430\u0439\u0431\u0443\u0442\u043D\u044C\u043E\u043C\u0443>");
                } else {
                    this.startBtn.disabled = false;
                    this.startBtn.addEventListener("click", this.countdownTime.bind(this));
                }
            }
        };
        (0, _flatpickrDefault.default)(this.dateChosen, options);
    }
    countdownTime() {
        this.timer = setInterval(()=>{
            this.startBtn.disabled = true;
            const dateChoosenMs = new Date(this.dateChosen.value.replace(/-/g, "/")).getTime();
...
const countdownTimer = new CountdownTimer("button[data-start]", "#datetime-picker", "[data-days]", "[data-hours]", "[data-minutes]", "[data-seconds]");
