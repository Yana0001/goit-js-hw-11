...
elements.searchBox.addEventListener("input", (0, _lodashDebounceDefault.default)(onInputSearch, DEBOUNCE_DELAY));
function onInputSearch(e) {
    ...
    (0, _fetchCountries.fetchCountries)(searchCountries).then((result)=>{
        if (result.length > 10) {
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","lodash.debounce":"3JP5n","./js/fetchCountries":"dKuy9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
